...
| **Транскрибация**   | OpenAI gpt-4o-transcribe (основной), gpt-4o-transcribe-diarize (спикеры) + ZAI GLM-ASR-2512 (альтернатива, реализован) + NVIDIA NeMo Parakeet TDT 0.6B V3 (local, оффлайн) |
...
│   ├── factory.py      # Provider factory (OpenAI/Z.AI/NeMo)
│   ├── adapter.py      # OpenAI API wrapper
│   ├── glm_asr_client.py  # Z.AI GLM-ASR wrapper
│   ├── nemo_client.py  # NeMo local ASR wrapper
